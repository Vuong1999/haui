...
public class ConfirmChangeMenuActivity extends Activity {
	...
	protected void doExit() {
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(
				ConfirmChangeMenuActivity.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.about:
			...
			break;
		case R.id.backhome:
			Intent i = new Intent(ConfirmChangeMenuActivity.this, MainActivity.class);
			i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
					| Intent.FLAG_ACTIVITY_CLEAR_TASK);
			ConfirmChangeMenuActivity.this.startActivity(i);
			break;
		}
	...
	class UpdateOrders extends AsyncTask<String, String, String> {
		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ConfirmChangeMenuActivity.this);
			pDialog.setMessage("Đang sửa món...");
		...
		protected String doInBackground(String... args) {
			try {
				...
				URL url = new URL("http://10.0.3.2:8080/qlnh/update_order.php");
		...
		protected void onPostExecute(String file_url) {
			pDialog.dismiss();
			ConfirmChangeMenuActivity.this.runOnUiThread(new Runnable() {
				public void run() {
					AlertDialog.Builder alertDialog = new AlertDialog.Builder(
							ConfirmChangeMenuActivity.this);
					...
					alertDialog.setMessage("Sửa món thành công.");
					alertDialog.setTitle("Quản lý nhà hàng");
					alertDialog.show();
				}
			});
