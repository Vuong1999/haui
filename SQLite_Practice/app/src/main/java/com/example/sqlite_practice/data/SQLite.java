package com.example.sqlite_practice.data;
...
public class SQLite extends SQLiteOpenHelper {
    ...
    public void addItem(Pet item) {
        ...
        values.put(Constants.KEY_DATE, System.currentTimeMillis());//lấy thòi gian của hệ thống
    ...
    public int updateItem(Pet item) {
        ...
        values.put(Constants.KEY_WEIGHT, item.getWeight());
        values.put(Constants.KEY_DESCRIPTION, item.getDescription());
        values.put(Constants.KEY_DATE, System.currentTimeMillis());//lấy thời gian của hệ thống
